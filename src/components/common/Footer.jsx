...
const Footer = () => {
          ...
          <ul className="space-y-2.5">
            {companyLinks.map((link) => (
              <li key={link.id}>
                <Link
                  href={link.path}
                  className=" text-[#B3B3BD] duration-200 hover:text-(--color-secondary)"
                >
                  {link.name}
                </Link>
              </li>
  ...
  ">
    ...
    "
            >
              <FaRegMessage size={16} className="text-(--color-secondary)" />
          ...
          <p>
            <a
              ...
              className="flex items-center gap-2 hover:text-(--color-secondary) text-[#B3B3BD]"
            >
              <IoCallOutline size={16} className="text-(--color-secondary)" />
              +91 9297626262
            </a>
          </p>
        </address>
