...
export default function PortfolioShowcase({ projects }) {
  return (
    <section id="projects" data-theme="light" className="py-16 md:py-20 lg:py-24 bg-[#faf9f6]">
        ...
        <div className="flex flex-wrap justify-center items-center xl:justify-center gap-7">
          {projects.map((project, index) => (
            <RevealOnScroll key={project.id} delay={index * 80}>
              <article className="group relative w-full sm:w-[420px] rounded-2xl border border-[#f2c5be] bg-white overflow-hidden transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_24px_45px_rgba(251,101,87,0.16)]">
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-[#2c2c2c]/70 via-[#2c2c2c]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-400 flex items-end p-5">
                    <Link
